                    ...
                    {inputsConfig.map((input) => {
                        if (input.name === "logo" || input.name === "imagen") {
                            return (
                                <div key={input.name} className="space-y-2">
                                    <Text variant="label" className="text-sm font-medium text-gray-700">Logo</Text>
                                    <InputFile
                                    ...
                                    />
                                    {uploadingImage && (
                                        <Text variant="p" className="text-xs text-blue-600 flex items-center gap-1">
                                    ...
                                    {imagePreview && !uploadingImage && (
                                        <Text variant="p" className="text-xs text-green-600 flex items-center gap-1">
                                            Imagen lista
                                        </Text>
                                    )}
                                </div>
                        ...
                        return (
                            <div key={input.name} className="space-y-1">
                                <Text variant="label" className="text-sm font-medium text-gray-700 capitalize">
                                    {input.name}
                                </Text>
                                <DynamicInputs
                                    Inputs={[{
